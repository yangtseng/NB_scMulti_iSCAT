...
p <- ggplot(df, aes(x=factor(group, levels = c('Control\n(n=100)','ATRA_20μM\n(n=156)')), y=data)) + 
  ...
  geom_signif(comparisons = list(c('Control\n(n=100)','ATRA_20μM\n(n=156)')), 
              annotations = "p < 0.001", textsize = 7, size = 0.8, vjust = -.2, 
              y_position = 2.45) +
  ...
  coord_cartesian(ylim=c(1.7, 2.55)) + 
...
p <- ggplot(df, aes(x=factor(group, levels = c('Control\n(n=32)','ATRA_20μM\n(n=34)')), y=data)) + 
  ...
  theme(text = element_text(family = 'Arial'),
        ...
        legend.title = element_text(size = 16), legend.text = element_text(size = 15),
        legend.position = "None") +
  coord_cartesian(ylim=c(1.7, 2.25)) + 
...
p <- ggplot(df, aes(x=factor(group, levels = c('Control\n(n=40)','ATRA_20μM\n(n=40)')), y=data)) + 
  ...
  theme(text = element_text(family = 'Arial'),
        ...
        legend.title = element_text(size = 16), legend.text = element_text(size = 15),
        legend.position = "None") +
  coord_cartesian(ylim=c(1.95, 2.25)) + 
...
p <- ggplot(df, aes(x=factor(group, levels = c('Control\n(n=45)','ATRA_20μM\n(n=45)')), y=data)) + 
  ...
  theme(text = element_text(family = 'Arial'),
        ...
        legend.title = element_text(size = 16), legend.text = element_text(size = 15),
        legend.position = "None") +
  coord_cartesian(ylim=c(1.83, 2.2)) + 
